...
<div id="hw_plugins_server_options">
	...
	<table class="form-table">
		...
		<tr>
			<th scope="row">
				Server Status : <code><?php echo hiweb_plugins_server()->host()->get_status() ? 'ON' : 'OFF' ?></code>
			...
			<td id="front-static-pages">
				<?php if ( hiweb_plugins_server()->host()->get_status() ) : ?>
		...
		<tr>
			<th scope="row">
				Kickback. Allow to take remote plugins : <code><?php echo hiweb_plugins_server()->host()->get_kickback_status() ? 'ENABLE' : 'DISABLE' ?></code>
			...
			<td id="front-static-pages">
				...
				<?php else: ?>
					<?php if ( ! hiweb_plugins_server()->host()->get_kickback_status() ) : ?>
