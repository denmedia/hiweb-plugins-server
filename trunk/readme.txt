...
2. Activate the plugins through the `hiWeb Plugins Server` menu in WordPress
...
2. Client site plugins list for download to current site and activate them
3. Start server
4. Server plugins list for host them
